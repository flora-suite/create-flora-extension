...
This is an example of a Flora [topic alias extension](https://github.com/flora-suite/create-flora-extension). Topic alias extensions
...
Open the Flora desktop app (or `ctrl-R` to refresh if it is already open). Your
...
https://github.com/flora-suite/create-flora-extension
