...
function ExamplePanel({ context }: { context: PanelExtensionContext }): ReactElement {
  ...
  // subscriptions.
  useLayoutEffect(() => {
    // The render handler is invoked by Flora during playback when your panel needs
    ...
    context.onRender = (renderState, done) => {
      ...
      // render call, Flora shows a notification to the user that your panel is delayed.  Set the
